...
class OutletController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $newOutlet = $request->validate([
            ...
            'latitude'  => 'nullable|required_with:longitude|max:30',
            'longitude' => 'nullable|required_with:latitude|max:30',
            'types'     => 'nullable|required_with:latitude|max:30',
            'numWilaya'     => 'nullable|integer',
        ]);
    ...
    public function update(Request $request, Outlet $outlet)
    {
        ...
        $outletData = $request->validate([
            ...
            'longitude' => 'nullable|required_with:latitude|max:30',
            'numWilaya'     => 'nullable|integer',
            'types'     => 'nullable|required_with:latitude',
        ]);
