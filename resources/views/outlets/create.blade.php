            ...
            <form method="POST" action="{{ route('outlets.store') }}" accept-charset="UTF-8">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="types" type="text" class="form-control{{ $errors->has('types') ? ' is-invalid' : '' }}" name="types" value="{{ old('types') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input id="numWilaya" type="text" class="form-control{{ $errors->has('numWilaya') ? ' is-invalid' : '' }}" name="numWilaya" value="{{ old('numWilaya') }}" required>
